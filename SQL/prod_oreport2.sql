...
/*更新商品积分标记*/
/*update tmp_order_report set address_remark = '1' where tidi in (select tid from tmp_sku_remark);*/
update tmp_order_report a  inner join (
	select b.tid from tmp_sku_remark b
    ) c on a.tidi = c.tid set a.address_remark = '1';
commit;

(function (scope) {
    var _$AreaSaleReport = scope.$AreaSaleReport;
    var initialize = {
        define:function () {
...
//                        form: Ext.fly('frmDummy'),
                        ...
                        success : function(response) {
                            ...
                            if('none' == Ext.decode(response.responseText).result) {
                                ...
                                window.location.href = path('/download/downAreaSale.json?filePath='+result);
                            }
                            loadMarsk.hide();
                        },
...
//                                    handler:me.addExportTab(this)
                    ...
                    me.callParent();
                    me.getForm().load({url:path("/operationHistory/lastedOperationLog.json?operationType=DOWNLOAD_AREA_SALE")});
                }
    ...
    scope.$AreaSaleReport = sand_box();

})(this);

Ext.onReady(function () {
    Ext.tip.QuickTipManager.init();
    var index = $AreaSaleReport.createIndex();

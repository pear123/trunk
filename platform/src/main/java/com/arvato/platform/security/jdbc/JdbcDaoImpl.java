package com.arvato.platform.security.jdbc;
...
public class JdbcDaoImpl extends JdbcDaoSupport implements UserDetailsService {
    ...
    public static final String DEF_USERS_BY_USERNAME_QUERY =
            "SELECT user_Id,user_Password,user_Status " +
    ...
    protected List<UserDetails> loadUsersByUsername(String username) {
        return getJdbcTemplate().query(usersByUsernameQuery, getParameters(username), new RowMapper<UserDetails>() {
            ...
            public UserDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                //String isExpired = rs.getString(4);
//                String isLocked = rs.getString(5);
//                String isInit = rs.getString(6);
//                Date credentialListModifiedTime = rs.getDate(7);

//                boolean isCredentialExpired = false;
//                if (null != credentialListModifiedTime) {
//                    Calendar calendar = Calendar.getInstance();
//                    calendar.add(Calendar.DATE, -Integer.parseInt(Constants.CredentialCode.CredentialExpiredTime.getVal()));
//                    if (calendar.getTime().after(credentialListModifiedTime)) {
//                        isCredentialExpired = true;
//                    }
//                }

//                return new UserInfo(username, password, StringUtils.trim(isInit).equals("1") ? false : true, !isCredentialExpired,
//                        !isCredentialExpired,
//                        StringUtils.trim(isLocked).equals("1") ? false : true,
//                        StringUtils.trim(isInit).equals("1") ? false : true,
...
//                1	0 	0 	0
    ...
    protected UserDetails createUserDetails(String username, UserDetails userFromUserQuery,
        ...
        return new UserInfo(returnUsername, userInfo.getPassword(), userInfo.isEnabled(),
                true, userInfo.isCredentialsNonExpired(), userInfo.isAccountNonLocked(),
                userInfo.getCredentialNonInit(), combinedAuthorities);
    }
    ...
    private String[] getParameters(String username) {

        String[] parameters = new String[usersByUsernameQuery.split("\\?").length];

 ...
 * <p>
 * Refer to {@link org.springframework.security.access.intercept.AbstractSecurityInterceptor} for details on the workflow.</p>
 *
 * @author Ben Alex
 * @version $Id: FilterSecurityInterceptor.java 3752 2009-07-08 23:55:42Z ltaylor $
 */
public class BshFilterSecurityInterceptor extends FilterSecurityInterceptor{
     ...
     * @param arg0 ignored
     *
     * @throws javax.servlet.ServletException never thrown
     */
     ...
     * #invoke(org.springframework.security.web.FilterInvocation)} method.
     *
     * @param request the servlet request
     * @param response the servlet response
     * @param chain the filter chain
     *
     * @throws java.io.IOException if the filter chain fails
     * @throws javax.servlet.ServletException if the filter chain fails
     */

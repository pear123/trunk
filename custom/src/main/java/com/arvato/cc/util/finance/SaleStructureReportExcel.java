...
public class SaleStructureReportExcel extends BaseReportExcel<SaleStructureBean> {
    //自定义起始行
    ...
    public SaleStructureReportExcel(List<SaleStructureBean> saleStructureBeanList) {
